...
def animate_ball():
    ...
    if ball.bottom >= screen_heigh or ball.top <= 0:
        ball_speed_y *= -1
...
def animate_player():
    ...
    if player.top <= 0:
        player_speed = 0
    if player.bottom >= screen_heigh:
        player.bottom = screen_heigh
...
def animate_cpu():
    ...
    if cpu.top <= 0:
        cpu.top = 0
    if cpu.bottom >= screen_heigh:
        cpu_bottom = screen_heigh
...
ball.center = (screen_width/2, screen_heigh/2)

cpu = pygame.Rect(0,0,20,100)
cpu.centery = screen_heigh/2

player = pygame.Rect(0,0,20,100)
player.midright = (screen_width, screen_heigh/2)
...
while True:
    ...
    pygame.draw.aaline(screen, 'white',(screen_width/2, 0), (screen_width/2,screen_heigh))
